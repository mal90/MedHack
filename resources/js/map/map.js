...
//            Markers for Doctor Search
            {latitude: 7.1525817, longitude: 79.9268858, group: 'doctor', icon: 'images/map/01.png', html: {
                    content: 'Lorem ipsum dolor sit amet.<br /><a href="company-page.html">Read More</a>'
                }},
            {latitude: 6.9847183, longitude: 79.8853751, group: 'doctor', icon: 'images/map/01.png', html: {
                    content: 'Lorem ipsum dolor sit amet.<br /><a href="company-page.html">Read More</a>'
                }},
            {latitude: 6.9251091, longitude: 79.8999927, group: 'doctor', icon: 'images/map/01.png', html: {
                    content: 'Lorem ipsum dolor sit amet.<br /><a href="company-page.html">Read More</a>'
                }},
            {latitude: 6.92567445, longitude: 79.88674096, group: 'doctor', icon: 'images/map/01.png', html: {
                    content: 'Lorem ipsum dolor sit amet.<br /><a href="company-page.html">Read More</a>'
                }}
                //,
...
//                 }}
    ...
    jQuery('#doctor-location').goMap({
        ...
        scrollwheel: false,
        markers: [
            {latitude: 6.9271, longitude: 79.8612, group: 'doctor', icon: 'images/map/01.png', html: {
                    content: 'Lorem ipsum dolor sit amet.<br /><a href="company-page.html">Read More</a>'
                }}
        ]
    });
